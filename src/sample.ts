...
// Rest arguments
const buildName = (first: string, ...rest: Array<string>) => first + ' ' + rest.join(' ');
...
type NameType = typeof john;
function sayName({ firstName, lastName, middleName = 'N/A' }: Partial<NameType>) {
